      ...
      {tab === 'overview' && (
        <div className="space-y-4">
          <div className="grid grid-cols-3 gap-2.5">
            <Card className="border border-border/40 shadow-none"><CardContent className="p-3.5">
              ...
              <p className="text-xs text-muted-foreground/80 mt-2 leading-none whitespace-nowrap">总 {total} 条</p>
            </CardContent></Card>
            <Card className="border border-border/40 shadow-none"><CardContent className="p-3.5">
              ...
              <p className="text-xs text-muted-foreground/80 mt-2 leading-none whitespace-nowrap">已完成占比</p>
            </CardContent></Card>
            <Card className="border border-border/40 shadow-none"><CardContent className="p-3.5">
              ...
              <p className="text-xs text-muted-foreground/80 mt-2 leading-none whitespace-nowrap">已复盘占比</p>
            </CardContent></Card>
          </div>
